...
************************************************************************************* */
vector<RuleMatchInfo> RuleTable::find_matched_rules_for_syntax_node(SyntaxNode* cur_node)
{
...
************************************************************************************* */
void RuleTable::push_matched_rules_at_next_level(vector<RuleMatchInfo> &match_info_vec, RuleMatchInfo &cur_match_info)
{
